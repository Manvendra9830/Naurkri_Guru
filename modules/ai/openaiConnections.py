...
OpenAI / OpenAI-compatible API integration module.
Based on Auto_job_applier_linkedIn by Sai Vignesh Golla
...
from modules.helpers import print_lg, critical_error_log, convert_to_json, safe_confirm
...
def ai_error_alert(message: str, stackTrace: str, title: str = "AI Connection Error") -> None:
    ...
    if showAiErrorAlerts:
        if "Pause AI error alerts" == safe_confirm(f"{message}{stackTrace}\n", title, ["Pause AI error alerts", "Okay Continue"]):
