######################################################  NAUKRI_GURU — SEARCH PREFERENCES  ######################################################
...
date_posted = ["Past month", "Past week", "Past 24 hours"]         # "Any time", "Past month", "Past week", "Past 24 hours" or ("" to not select)
salary = ""                        # "$40,000+", "$60,000+", "$80,000+", "$100,000+", "$120,000+", "$140,000+", "$160,000+", "$180,000+", "$200,000+"

easy_apply_only = False             # Set False to find ALL jobs (Easy Apply + External). Many Indian AI/ML roles are external.
...
location = []                      # Leave empty to use search_location only — dynamic location filters often fail
industry = []                      # Leave empty — dynamic industry filters often fail on LinkedIn's current UI
